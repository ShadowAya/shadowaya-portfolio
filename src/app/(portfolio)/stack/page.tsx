...
export const metadata: Metadata = {
    title: "stack",
    alternates: {
        canonical: "https://shadowaya.me/stack",
    },
};
        ...
        <PageScroll height={921}>
                    ...
                    <>
                        ...
                        <StackItem>
                            ...
                            <p>
                                NextJS
                                <br />
                                <Opacity opacity={0.7}>(App dir)</Opacity>
                            </p>
                        </StackItem>
                        <StackItem>
                            <Iconify
                        ...
                        <StackItem>
                            ...
                            <p>
                                Vue
                                <br />
                                <Opacity opacity={0.7}>(Learning)</Opacity>
                            </p>
                        </StackItem>
                        <h3>Databases</h3>
                        <StackItem>
                            ...
                            <p>
                                Postgres
                                <br />
                                <Opacity opacity={0.7}>(& SQL)</Opacity>
                            </p>
                        </StackItem>
                        <StackItem>
                            <Image
            ...
            >
                ...
                <StackItem>
                    ...
                    />
                    <p>
                        C# <Opacity opacity={0.7}>(basics)</Opacity>
                    </p>
                </StackItem>
                <StackItem>
                    <Iconify
                    ...
                    <p>
                        Python{" "}
                        <Opacity opacity={0.7}>(basics, scripting)</Opacity>
                    </p>
                </StackItem>
            </ComputerWindow>
            <ComputerWindow
